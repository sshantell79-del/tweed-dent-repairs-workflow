  ...
  return (
    <SafeAreaView style={styles.container} edges={['top']}>
      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.section}>
          <TouchableOpacity style={styles.menuRow} onPress={() => Alert.alert('Business Details', 'Edit your business name, address, phone, and ABN. Coming soon!')}>
            <View style={styles.settingInfo}>
          ...
          <TouchableOpacity style={styles.menuRow} onPress={() => router.push('/quotes')}>
            <View style={styles.settingInfo}>
          ...
          <TouchableOpacity style={styles.menuRow} onPress={() => Alert.alert('Invoice Settings', 'Configure invoice templates, payment terms, and GST. Coming soon!')}>
            <View style={styles.settingInfo}>
