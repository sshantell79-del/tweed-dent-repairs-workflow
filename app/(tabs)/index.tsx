      ...
      >
        ...
        <View style={styles.statsGrid}>
          ...
          <TouchableOpacity 
            ...
            onPress={() => router.push({ pathname: '/(tabs)/jobs', params: { filter: 'In Progress' } })}
          >
        ...
        >
          ...
          <View style={styles.quickAddContent}>
            <Text style={styles.quickAddTitle}>Quick Add New Job</Text>
            <Text style={styles.quickAddSubtitle}>Tap to create a new job</Text>
          </View>
